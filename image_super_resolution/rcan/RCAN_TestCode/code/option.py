...
parser.add_argument('--precision', type=str, default='single',
                    choices=('single', 'half', 'bfloat16'),
                    help='FP precision for test (single | half | bfloat16)')
...
# options for sycl
parser.add_argument('--sycl', action='store_true',
                    help='use sycl')

# options for jit
parser.add_argument('--enable-jit', default=False,
                    help='use jit')
