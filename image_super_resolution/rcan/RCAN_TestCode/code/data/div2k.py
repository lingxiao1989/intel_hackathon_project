...
class DIV2K(srdata.SRData):
    ...
    def _set_filesystem(self, dir_data, data_type='train'):
        self.apath = dir_data + '/DIV2K'
        self.dir_hr = os.path.join(self.apath, 'DIV2K_{}_HR'.format(data_type))
        self.dir_lr = os.path.join(self.apath, 'DIV2K_{}_LR_bicubic'.format(data_type))
        self.ext = '.png'
